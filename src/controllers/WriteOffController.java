...
public class WriteOffController {
    ...
    @FXML
    void buttonAddInCart(ActionEvent event) {
    ...
    @FXML
    void initialize() {
        assert editTextComicName != null : "fx:id=\"editTextComicName\" was not injected: check your FXML file 'writeoff.fxml'.";
        assert tableComics != null : "fx:id=\"tableComics\" was not injected: check your FXML file 'writeoff.fxml'.";
